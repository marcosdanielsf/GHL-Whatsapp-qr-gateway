...
export const Icons = {
  Connected: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="currentColor" viewBox="0 0 20 20" {...props}>
      <path
        fillRule="evenodd"
  ...
  Connecting: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="currentColor" viewBox="0 0 20 20" {...props}>
      <path
        fillRule="evenodd"
  ...
  Disconnected: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="currentColor" viewBox="0 0 20 20" {...props}>
      <path
        fillRule="evenodd"
  ...
  QrCode: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Error: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  Phone: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Clock: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  ChartBar: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Webhook: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Save: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 3v4h8" />
    </svg>
  ),
  Plug: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
    </svg>
  ),
  Link: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
    </svg>
  ),
  CreditCard: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
    </svg>
  ),
  Broadcast: ({ className, ...props }: IconProps) => (
    <svg className={iconClass(className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
